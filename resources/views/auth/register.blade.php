...
<div class="py-10 flex justify-center">
    <div class="bg-white shadow-md border border-gray-200 rounded-lg w-96 p-4 sm:p-6 lg:p-8">
        ...
        <form class="space-y-6" action="" method="post">
            <h3 class="text-xl font-medium text-gray-900">新規登録</h3>
            <div>
                <label for="name" class="text-sm font-medium text-gray-900 block mb-2">ユーザー名</label>
                <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="" required="">
            </div>
            <div>
