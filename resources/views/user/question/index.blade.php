...
@section('contents')
    ...
    <div class="my-3 mx-3">
        ...
        <form action="{{route('user.question.create')}}" method="post">
            <div class="flex mb-3">
            ...
            <div class="flex justify-center">
                <button type="submit" class="text-xs text-white bg-blue-600 hover:bg-blue-700 rounded-sm px-9 py-3 font-sans">
                    質問する
                </button>
            </div>
            @csrf
